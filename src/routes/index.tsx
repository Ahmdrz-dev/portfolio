...
const PORTRAIT = "/assets/myself2.jpg";
const milowra = "/assets/milowra.png";
const FOREX = "/assets/forex.jpg";
      ...
      <main className="pt-32 relative z-10">
        ...
        <section id="work" className="px-5 md:px-16 max-w-[1280px] mx-auto mb-[120px] pt-24">
          <div className="flex justify-between items-end mb-16 md:mb-24 reveal-up">
            ...
            <div className="hidden md:block text-body-md text-[#5e5e5e] italic">{t('work.period')}</div>
          </div>
...
function CaseStudy({ img, title, desc, tags, year, overlay, reverse, url, visitWebsiteText }: CaseStudyProps) {
  return (
    <div className={`flex flex-col gap-8 md:gap-16 lg:gap-24 items-center reveal-up ${reverse ? "md:flex-row-reverse" : "md:flex-row"}`}>
      ...
      <div className="w-full md:w-3/5">
        <div className="relative aspect-[4/3] w-full bg-[#efeeeb] overflow-hidden border border-[#c4c7c7]">
          <img 
      ...
      <div className="w-full md:w-2/5 flex flex-col justify-center items-start">
        <h3 className="font-display text-headline-lg mb-4">{title}</h3>
